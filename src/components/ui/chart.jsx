...
function ChartTooltipContent({
    ...
    if (labelFormatter) {
      return (
        <div className={cn(labelClassName)}>
          <strong>{labelFormatter(value, payload)}</strong>
        </div>
      );
    }
  ...
  return (
    <div
      className={cn(
        "grid min-w-32 items-start gap-1.5 rounded-md border border-border/50 bg-background px-2.5 py-1.5 text-sm shadow-xl",
        className
      )}>
