...
- **Today:** the same appointments regrouped into five status columns instead — Scheduled (Late included, distinguished by its own pill), With Assistant, With Physician, Finished, Other (No Show + Cancelled folded together).
