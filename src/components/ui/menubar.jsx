...
function Menubar({
  ...
  return (
    <MenubarPrimitive.Root
      data-slot="menubar"
      className={cn("flex h-8 items-center gap-0.5 rounded-md border p-[3px]", className)}
      {...props} />
  );
}
...
function MenubarLabel({
  ...
  return (
    <MenubarPrimitive.Label
      ...
      data-inset={inset}
      className={cn("px-1.5 py-1 text-sm data-inset:pl-7", className)}
      {...props} />
  );
}
...
function MenubarShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-sm tracking-widest text-muted-foreground group-focus/menubar-item:text-accent-foreground",
        className
      )}
      {...props} />
  );
